...
export default function Ssignup() {
  ...
  return (
    <div>
        <div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto register">
    <div class="card crd002 border-0">
        <div class="row d-flex">
            <div class="col-lg-6">

                <div class="row px-5">
                    <div class="col-md-8 align-self-start c">
                        <h2>Resister As a Student</h2>
                    </div>
                ...
                <form>
                    ...
                    <div class="text-center w-100">
                        <p class="text-muted font-weight-bold">Already Registered? <a href="login.html" class="text-primary ml-2"><Link to="/Login" >Login</Link></a></p>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    ...
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="teacher-signup-image.png" class="image"/>
                </div>
            </div>
        </div>
